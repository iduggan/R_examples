...
barplot(height=data$value, 
        names=data$name, 
        border="#69b3a2", 
        col=rgb(1,0,0,1/4), # not your color, but demos opacity
        ylab= "% Growth", 
        main= "Overall Percent Regrowth: All Trials", 
        sub= expression(italic("Dugesia Tigrina")),
        cex.lab = 1, cex.main = 2, cex.sub = 1.5, 
        ylim=c(0,80))
